...
* [Canned Responses Admin Guides](https://github.com/spastorelli/RocketChatDocs/blob/test-datasync-changes/use-rocket.chat/omnichannel/canned-responses/broken-reference/README.md)
